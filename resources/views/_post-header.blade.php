            ...
            <div x-data="{ show: false }">
                ...
                <div class="py-2 absolute bg-gray-100 mt-2 rounded-xl w-full z-50" x-show="show" style="display:none">
                    ...
                    @foreach ($categories as $category)
                        <a href="/db/category/{{ $category->slug }}"
                            class="block text-left px-3 text-sm leading-6 hover:bg-blue-500 hover:text-white focus:bg-blue-500 focus:text-white {{ isset($currentCategory) && $currentCategory->is($category) ? 'bg-blue-500 text-white' : '' }}">
